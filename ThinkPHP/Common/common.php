...
/**
 * Think 基础函数库 全局必须加载的基础函数库，在任何时候都可以直接调用
 * @category   Think
 * @package  Common
 * @author   liu21st <liu21st@gmail.com>
 */
...
function service( $name )
{
    ...
    $layer         = 'Service';
    $suffix        = '.class.php';
    $trueClassName = $className . $layer;
    $classPath     = LIB_PATH . $dir . $trueClassName . $suffix;

    if ( !$_instance[ $className ] ) {
        require_once $classPath;
        $_instance[ $className ] = new $trueClassName();
    }

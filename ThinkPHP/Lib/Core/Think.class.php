...
class Think {
    ...
    public static function autoload($class) {
        ...
        $libPath    =   defined('BASE_LIB_PATH')?BASE_LIB_PATH:LIB_PATH;    //  ./App/Lib/
        $group      =   defined('GROUP_NAME') && C('APP_GROUP_MODE')==0 ?GROUP_NAME.'/':'';  // ''
        $file       =   $class.'.class.php';

        // CORE_PATH:     E:\core\wamp\www\thinkphp313\ThinkPHP/Lib/
        // EXTEND_PATH:   E:\core\wamp\www\thinkphp313\ThinkPHP/Extend/
        // LIB_PATH:      ./App/Lib/
        // MODE_PATH:      E:\core\wamp\www\thinkphp313\ThinkPHP/Extend/Mode/

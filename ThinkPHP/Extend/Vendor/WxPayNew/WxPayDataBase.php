...
require_once "WxPayCurl.php";
require_once "WxPayResult.php";
require_once "WxPayConfig.php";  //todo 该配置项可根据不同框架已到对应的配置目录中，而不应该在api目录中

/**
 * 数据对象基类
 * 该类中定义数据类最基本的行为，包括：计算/设置/获取签名、输出xml格式的参数、从xml读取数据对象等
 * Author: youxi
 * Date:   2015/9/28 9:29
 *
 */
class WxPayDataBase
{
    ...
    /**
     * 获取trade_type=JSAPI，此参数必传，用户在商户appid下的唯一标识。下单前需要调用【网页授权获取用户信息】接口获取到用户的Openid的值
     * @return 值
     **/

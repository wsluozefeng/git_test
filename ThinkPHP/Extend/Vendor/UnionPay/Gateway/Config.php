...
// 签名证书路径
//const SDK_SIGN_CERT_PATH = 'E:\core\wamp\www\upacp_sdk_php\700000000000001_acp.pfx';
const SDK_SIGN_CERT_PATH = '/mnt/hgfs/thinkphp313/ThinkPHP/Extend/Vendor/UnionPay/Cert/700000000000001_acp.pfx';

// 签名证书密码
 const SDK_SIGN_CERT_PWD = '000000';

// 密码加密证书（这条用不到的请随便配）
//const SDK_ENCRYPT_CERT_PATH = 'E:\core\wamp\www\upacp_sdk_php\verify_sign_acp.cer';
const SDK_ENCRYPT_CERT_PATH = '/mnt/hgfs/thinkphp313/ThinkPHP/Extend/Vendor/UnionPay/Cert/verify_sign_acp.cer';

// 验签证书路径（请配到文件夹，不要配到具体文件）
//const SDK_VERIFY_CERT_DIR = 'E:\core\wamp\www\upacp_sdk_php';
const SDK_VERIFY_CERT_DIR = '/mnt/hgfs/thinkphp313/ThinkPHP/Extend/Vendor/UnionPay/Cert/';
...
const SDK_FRONT_NOTIFY_URL = 'http://www.tp.com/index.php/Pay/unionPayFrontReceive';

// 后台通知地址 (商户自行配置通知地址)
//const SDK_BACK_NOTIFY_URL = 'http://114.82.43.123/upacp_sdk_php/demo/utf8/BackReceive.php';
const SDK_BACK_NOTIFY_URL = 'http://shwguan.com/yinlian.php';

//文件下载目录 
const SDK_FILE_DOWN_PATH = 'E:\core\wamp\www\upacp_sdk_php\file\\';

//日志 目录 
const SDK_LOG_FILE_PATH = '/mnt/hgfs/thinkphp313/App/Runtime/';
